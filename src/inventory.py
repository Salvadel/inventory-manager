...
# A function to update an inventory item, it takes the item_id and the updated item data as input, validates the updated data using the security module, and then calls the database function to update the item in the inventory with the new data
def update_inventory_item(item_id, name=None, quantity=None, date_added=None, 
    date_expired=None, location=None, category=None, vendor=None):
    ...
    # Pass the fully constructed dictionary to the database
